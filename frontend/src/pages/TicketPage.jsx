...
import { Download, Share2, ArrowLeft, CheckCircle, Calendar, Clock, Users, MapPin } from 'lucide-react'
        ...
        >
          ...
          <div className="relative glass rounded-3xl border border-white/10 overflow-hidden shadow-card">
            ...
            <div className="px-6 py-5">
              ...
              <p className="text-brand-400 text-sm font-semibold mb-6 capitalize">
                {booking.show?.category}
              </p>
              ...
              <div className="flex flex-col items-center py-6 glass-light rounded-2xl border border-white/5">
                {booking.qr_code ? (
                  ...
                  <div
                    className="w-40 h-40 rounded-xl border-2 border-dashed border-brand-500/30 flex items-center justify-center"
            ...
            <div className="px-6 py-5 flex gap-3">
              ...
              <button
                onClick={handleShare}
                className="flex-1 glass-light border border-white/10 text-white font-bold py-3.5 rounded-2xl flex items-center justify-center gap-2 text-sm hover:bg-white/10 transition-all"
              >
