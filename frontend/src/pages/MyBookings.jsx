...
import { Ticket, Calendar, Users, IndianRupee, Eye, X, Search } from 'lucide-react'
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex flex-wrap gap-4 text-dark-400 text-sm">
                        ...
                        <span className="flex items-center gap-1.5">
                          ...
                          {b.total_tickets} ticket{b.total_tickets > 1 ? 's' : ''}
                        </span>
                        <span className="flex items-center gap-1.5">
                          <IndianRupee size={13} className="text-dark-500" />
                          {b.total_amount}
                        </span>
                      </div>
                    </div>
